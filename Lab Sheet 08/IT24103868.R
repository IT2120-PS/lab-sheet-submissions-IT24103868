...
print(paste("The Standard Deviation of Sample Means (", sd_of_sample_means, 
            ") is approximately equal to the Population Standard Deviation divided by the square root of the sample size (", 
